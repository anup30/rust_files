...
cargo run --bin 01_hello_world (run the specific file, if kept in src/bin/)
---
or, run by single click code runner icon 
  // ctrl+, -> "executorMap" -> in settings.json, in "code-runner.executorMap" : 
