...
// from containing folder:
  pwsh5: rustc -O "04c_cp_input3.rs" --crate-name run_program; Get-Content input.txt | .\run_program.exe
  pwsh5: rustc "04c_cp_input3.rs" --crate-name run_program; .\run_program.exe 

// using cmd from containing folder:
  cmd: rustc "04c_cp_input3.rs" --crate-name run_program && .\run_program 
  cmd: rustc "04c_cp_input3.rs" --crate-name run_program && .\run_program < input.txt
